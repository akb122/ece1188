...
#define TOOCLOSE 365 //was 200
#define DESIRED 400 //was 250
int32_t SetPoint = 365; // mm //was 250
int32_t LeftDistance,CenterDistance,RightDistance; // mm
#define TOOFAR 500 // was 400

#define PWMNOMINAL 10000 // was 2500
#define SWING 5000 //was 1000
...
void Controller_Right(void){ // runs at 100 Hz
  if(Mode){
    ...
    if((RightDistance<400) && (CenterDistance <400)){
        UL = 0;
        UR = PWMNOMINAL;
    }

//    if(RightDistance>550)
//    {
//        UL = PWMNOMINAL;
//        UR = PWMNOMINAL-250;
//    }
...
void main(void){ // wallFollow wall following implementation
  ...
  UART0_Init();//12,000,000 / 9600 = 1250
